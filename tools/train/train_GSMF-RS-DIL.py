...
def parse_args():
    ...
    parser.add_argument('--work-dir', default='result/GSMF-RS-DIL-ISPRS', help='the dir to save logs and models')
    '''
    # GSMF-RS-DIL-LoveDA
    parser.add_argument('--config',default='configs/gsmf_rs_dil_r101-d8_4xb4-80k_LoveDA-512x512.py',help='train config file path')
    parser.add_argument('--work-dir', default='result/GSMF-RS-DIL-LoveDA',help='the dir to save logs and models')
    '''
